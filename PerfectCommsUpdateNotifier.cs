...
internal static class PerfectCommsUpdateNotifier
{
    ...
    private static void Show(MainMenuManager menu, PerfectCommsUpdateInfo info)
    {
        ...
        CreateText("Title", new Vector3(0f, 0.17f, -0.2f), VoiceChatLocalSettings.Censor("Mega Chujowe Perfect Comms Update Available"), 0.92f, Accent, TextAlignmentOptions.Center);
